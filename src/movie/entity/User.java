...
public class User {
    ...
    @Basic
    @Column(name = "useraccount", nullable = true, length = 6)
    ...
    @Basic
    @Column(name = "usersex", nullable = true, length = 1)
    ...
    @Basic
    @Column(name = "userpassword", nullable = true, length = 6)
    ...
    @Basic
    @Column(name = "usertell", nullable = true, length = 11)
    ...
    public boolean equals(Object o) {
        ...
        return id == user.id &&
                ...
                Objects.equals(usertell, user.usertell) &&
