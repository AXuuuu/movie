...
<body style="background-image: url(img/newbacktwo.jpg);background-repeat: no-repeat;background-size: 100%">
    <!-- ##### Header Area Start ##### -->
    ...
    <%--添加新闻--%>
    <section class="row" style="width: 100%;margin: 0 auto;background: url(img/newbacktwo.jpg);background-repeat: no-repeat;background-size: 100%;margin-top: -60PX">
        ...
        <div class="col-md-8 col-md-offset-2" style="margin-top: -50px">
            <form action="addNewsAction.action" class="fh5co-form animate-box" data-animate-effect="fadeInRight" method="post" style="border-radius: 20px">
                <div class="form-group">
                    <label for="id" class="sr-only">新闻编号</label>
                    <input type="text" class="form-control" id="id" placeholder="新闻编号" name="id">
                </div>
                <div class="form-group">
                ...
                <div class="form-group" >
                    <div id="kindeditor" style="margin-top: 5px;">
...
<%--                        <textarea id="kindedito" name="kindeditom" placeholder="新闻内容" rows="5" cols="80">--%>
                        </textarea>
