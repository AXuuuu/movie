...
<body >
    ...
    <%--添加电影--%>
    <section class="row" style="width: 100%;margin: 0 auto;background: url(img/newbacktwo.jpg);background-repeat: no-repeat;background-size: 100%;margin-top: -90px;">
        ...
        <div class="col-md-8 col-md-offset-2">
            <form action="AddMovieAction.action" class="fh5co-form animate-box" data-animate-effect="fadeInRight" method="post" enctype="multipart/form-data" style="border-radius: 20px;margin-top: 20px;">
                ...
                <div class="form-group">
                    <label for="upload" class="sr-only">上传电影</label>
<%--                    <input type="file" class="form-control" id="upload" placeholder="上传电影" name="upload">--%>
                    <input type="String" class="form-control" id="upload" placeholder="上传电影" name="upload">
                </div>
